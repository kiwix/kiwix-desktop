     ...
     ----------------------
     If you only want to **use Kiwix Desktop** and are not building it from source,
     you can use the official prebuilt binaries.
     ...
     Note: Commands using sudo, make, or ldconfig apply only to Linux or WSL environments.


     ### Linux

     Kiwix Desktop is available through distribution package managers and via
     Flatpak (Flathub).
     ...
     * https://bugreports.qt.io/browse/QTBUG-126989
     ...
     Compilation on Microsoft Windows (Advanced / WSL)
     --------------------------------
     This section describes building Kiwix Desktop in a Linux-like environment
     on Windows (for example using Windows Subsystem for Linux or MSYS2).
     It is intended for developers and advanced users.

     Native Windows users who only want to run Kiwix Desktop should use the
     prebuilt binaries described above.
